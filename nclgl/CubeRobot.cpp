...
CubeRobot::CubeRobot(void) {
	//uncomment for local origin marker
	SetMesh(cube);
	...
	body->SetBoundingRadius(150.0f);
	head->SetBoundingRadius(50.0f);

	leftArm->SetBoundingRadius(180.0f);
	rightArm->SetBoundingRadius(180.0f);

	leftLeg->SetBoundingRadius(180.0f);
	rightLeg->SetBoundingRadius(180.0f);
